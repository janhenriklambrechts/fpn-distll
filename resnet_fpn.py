...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, fpn_in_channels, fpn_out_channels, fpn_num_outs, 
                 num_classes=100, zero_init_residual=False,
        ...
        self.fpn = FPN(in_channels=fpn_in_channels, out_channels=fpn_out_channels,
    ...
    def forward(self, x):
        ...
        fpns_out= self.fpn(feature_list)
        fpn_preds= self.fpn_head(fpns_out)
        #print(type(fpn_preds))
        outs= [out4]  + fpn_preds
        #print(len(outs))
        return outs 
...
if __name__ == '__main__':
    ...
    print("%s | %.2f | %.2f" % ('ResNet Slim', total_params / (1000 ** 2), total_ops / (1000 ** 3)))
